<?php 
    ...
    $UID = $_SESSION['ID'];
    $getAllArt = $conn->query("SELECT * FROM `tbl_paintings` WHERE `UID` = $UID order by DateTime DESC");
?>

<div class="card">
                  <div class="card-header">
                    <h4>Your art Posts</h4>
                  </div>
                  <div class="card-body">
                            ...
                            <?php $i = 1; while($art = $getAllArt->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><?php 
                                        ...
                                        echo $count['Total'];
                                    ?></td>
                                    <td><a href="Art_Detail.php?ID=<?php echo $art['ID'] ?>" class="btn btn-primary">Detail</a></td>
                                </tr>
                            <?php $i++; endwhile; ?>
                        </tbody>
                      </table>
