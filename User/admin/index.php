                ...
                <div class="row ">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">
                            <?php
                                $getAllArt = $conn->query("SELECT COUNT(*) AS `Total` FROM `tbl_paintings` ");
                                $Art =  $getAllArt->fetch_assoc();
                                echo  $Art['Total'];
                            ?>
                          </h2>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">
                            <?php
                                $getAllCom = $conn->query("SELECT COUNT(*) AS `Total` FROM `tbl_user`");
                                $Com =  $getAllCom->fetch_assoc();
                                echo  $Com['Total']-1;
                            ?>
                          </h2>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15"> Total Professional </h5>
                          <h2 class="mb-3 font-18">
                          <?php
                                $getAllCom = $conn->query("SELECT COUNT(*) AS `Total` FROM `tbl_user` WHERE `Role` = 'P'");
                                $Com =  $getAllCom->fetch_assoc();
                                echo  $Com['Total'];
                            ?>
                          </h2>
